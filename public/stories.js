var STORIES = {
  ...
  "February 2015": {
    label: 'Los Angeles',
    copy: 'L.A.’s recent mass-influx of artists has perhaps drawn the most fervent art-world attention in recent years—major international galleries have flooded in as well. And, in September, the city’s biggest artistic benefactors, Eli and Edythe Broad, opened <a href="https://www.artsy.net/thebroad">The Broad</a>, a $140 million new home for their collection, to <a href="http://www.nytimes.com/2015/09/13/arts/design/review-broad-museum-los-angeles.html?_r=0">critical acclaim</a>.'
  },
  "March 2015": {
    label: 'Hong Kong',
  ...
  "April 2015": {
    label: 'São Paulo',
    copy: 'Though 2015 did not include an edition of the ever-influential São Paulo Biennial, Brazil’s financial center remains South America’s first city for art. That’s thanks to April’s <a href="https://www.artsy.net/sp-arte-2015">SP–Arte</a> and a host of influential galleries such as <a href="https://www.artsy.net/mendes-wood">Mendes Wood DM</a> and <a href="https://www.artsy.net/nara-roesler">Galeria Nara Roesler</a>.',
    labeltwo: 'Brussels',
    copytwo: 'Known for its significant collector base—likely the world’s highest concentration in any one metropole—and their penchant for emerging art, Brussels boasts an enviable bunch of galleries. Each April <a href="https://www.artsy.net/art-brussels-2015">Art Brussels</a> welcomes those outfits and a host of others from around the world to Belgium.'
  },
  "May 2015": {
    label: 'Venice',
  ...
  "July 2015": {
    label: 'Beijing',
    copy: 'Shanghai may host mainland China’s biggest market events, but Beijing remains the first city for artists in the world’s second-most-powerful economy. The scene is centered in the 798 Arts District, where major institutions like the <a href="https://www.artsy.net/ucca">Ullens Center for Contemporary Art (UCCA)</a> abut a growing number of dealers.'
  },
  "August 2015": {
    label: 'Detroit',
    copy: 'Detroit has been lauded as America’s Berlin for the past several years. And the Motor City continues to attract alternative spaces looking to jump the coasts’ hustle (and steep rents). Detroit also serves as a stand-in on this list for emerging art capitals worldwide, from Mexico City to Mumbai, Bogotá to Beirut, and beyond.'
  },
  "September 2015": {
    label: 'Berlin',
    ...
    labeltwo: 'Istanbul',
    copytwo: 'dOCUMENTA (13)’s beloved artistic director Carolyn Christov-Bakargiev curated the <a href="https://www.artsy.net/show/istanbul-biennial-the-14th-istanbul-biennial-saltwater">14th Istanbul Biennial</a>, drawing all eyes to the Bosphorus’s shores this fall. The city’s unique position between East and West continues to make it a rich context for art to unfold within.'
  },
  "October 2015": {
    label: 'London',
    copy: 'Over the past decade, the London contemporary art scene has taken an upward turn, thanks in no small part to the city’s ability to attract the global elite. The Frieze Art Fair brings the balance of the art world to London each October. And, from the Tate to the Whitechapel, the ICA to the RA, the city’s museums <i>at least</i> rival those of New York.',
    labeltwo: 'Paris',
    copytwo: 'Paris welcomes the art world each October for the Grande Dame of art fairs, <a href="https://www.artsy.net/article/artsy-editorial-the-10-best-booths-at-fiac-from-a">FIAC</a>—and, this year, impressive young upstart <a href="https://www.artsy.net/article/artsy-editorial-paris-internationale-shows-why-smaller-more-curated-experiences">Paris Internationale</a>. Meanwhile, its host of influential gallerists and institutions bolster the critical conversation year-round.'
  },
  "November 2015": {
    label: 'New York City',
