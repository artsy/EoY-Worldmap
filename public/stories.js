var STORIES = {
  ...
  }, // Hong Kong //Art Basel christened Hong Kong a major art-world capital in 2013 when they purchased ART HK. (The fair moved to March this year, under its new moniker.) The city serves as Asia’s economic hub, making it the region’s natural art market epicenter.
  "April 2015": {
    label: 'São Paulo',
  ...
  }, // Brussels //Known for its significant collector base—likely the world’s highest concentration in any one metropole—and their penchant for emerging art, Brussels boasts an enviable bunch of galleries. Each April Art Brussels welcomes those outfits and a host of others from around the world to Belgium.
  "May 2015": {
    label: 'Venice',
  ...
  }, // Istanbul //dOCUMENTA (13)’s beloved artistic director Carolyn Christov-Bakargiev curated the 14th Istanbul Biennial this year, drawing all eyes to the Bosphorus’s shores this fall. The city’s unique position between East and West continues to make it a rich context for art to unfold within.
  "October 2015": {
    label: 'London',
  ...
  "November 2015": {
    label: 'Paris',
    copy: 'Paris welcomes the art world each October for the Grande Dame of art fairs, FIAC—and, this year, impressive young upstart Paris Internationale. Meanwhile, its host of influential gallerists and institutions bolster the critical conversation year-round.'
  },
  "December 2015": {
